  ...
  return (
    <section className="relative py-32 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-blue-500/[0.06] rounded-full blur-[140px]"></div>
        <div className="absolute bottom-1/4 right-0 w-[500px] h-[500px] bg-violet-500/[0.05] rounded-full blur-[140px]"></div>
      </div>
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10 max-w-[1400px]">
        ...
        <div className="max-w-5xl mx-auto mb-20 text-center">
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="flex items-center gap-2.5 px-4 py-2.5 bg-slate-800/60 backdrop-blur-sm border border-slate-700/50 rounded-full">
              ...
              <span className="text-sm font-medium text-slate-300">Let's Talk</span>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8" id="contact">
          ...
          <div className="lg:col-span-1 space-y-6">
            {contactInfo.map((info, index) => (
              <div
                ...
                className="group relative bg-slate-800/40 backdrop-blur-sm border border-slate-700/40 rounded-xl p-6 hover:bg-slate-800/60 hover:border-slate-600/60 transition-all duration-300 cursor-pointer overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="relative">
                  <div 
                    className="inline-flex w-12 h-12 rounded-lg items-center justify-center mb-4 transform group-hover:scale-105 transition-all duration-300 border"
                    style={{ 
                  ...
                  <div className="mt-4 flex items-center gap-2 text-xs font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300">
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/40 rounded-xl p-6">
              ...
              <div className="h-px w-full bg-slate-700/40 my-3"></div>
          ...
          <div className="lg:col-span-2">
            <div 
              className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/40 rounded-xl p-8 lg:p-10"
              style={{
            ...
            >
              <div className="mb-8 flex items-start justify-between gap-4 flex-wrap">
                <div>
                  ...
                  <p className="text-slate-400 font-light">Prefer a quick chat? Book a 15-minute call or tell us about your project below.</p>
                </div>
                <a
                  href="https://cal.com/syndicate-solutions/15min"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/20"
                >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="bg-slate-900/60 border-slate-700/50 text-white placeholder:text-slate-500 focus:border-blue-500 focus:ring-blue-500/20 h-12"
                  />
                </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    required
                  >
                    <SelectTrigger className="bg-slate-900/60 border-slate-700/50 text-white focus:border-blue-500 focus:ring-blue-500/20 h-12">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="bg-slate-900/60 border-slate-700/50 text-white placeholder:text-slate-500 focus:border-blue-500 focus:ring-blue-500/20 resize-none"
                  />
                </div>
                ...
                <Button
                  ...
                  className="w-full h-14 bg-blue-500 hover:bg-blue-600 text-white font-semibold text-base rounded-lg shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 transform hover:scale-[1.01] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
